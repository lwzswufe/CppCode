...
/*
g++ -g -Wall -std=c++11 CircularQueue.h Multi_Thread_Queue.cpp -o Multi_Thread_Queue.exe
g++ -g -Wall -std=c++11 CircularQueue.h Multi_Thread_Queue.cpp -o Multi_Thread_Queue.o  -lpthread
*/
int rnd()
{   
    return rand() % 16;
